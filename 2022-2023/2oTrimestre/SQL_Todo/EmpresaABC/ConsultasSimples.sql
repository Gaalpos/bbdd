...
un 21%).
*/
select idFabricante, idProducto, descripcion, precioCompra, 1.21 IVA,  (precioCompra * 1.21 ) as precioTotal
from productos;
/*
...
*/
select *
from pedidos where month(fechaPedido) =3 ;

/*
9) Listar toda la información de los pedidos de marzo de los ultimos tres anos
*/
select * from pedidos where month(fechaPedido) = 3 and ;
...
*/
select *
from productos where idProducto like '%x';
...
select * from productos order by idfabricante , order by precioCompra;
