...
CREATE DATABASE BDJardineria CHARACTER SET utf8mb4;
USE BDJardineria;
...
CREATE TABLE cliente (
  ...
  codEmpleadoRep INTEGER DEFAULT NULL,
  limiteCredito DOUBLE DEFAULT NULL,
  PRIMARY KEY (codCliente),
  FOREIGN KEY (codEmpleadoRep) REFERENCES empleado (codEmpleado)
);
...
CREATE TABLE producto (
  ...
  precioCompra NUMERIC(15,2) DEFAULT NULL,
...
CREATE TABLE pago (
  codCliente INTEGER NOT NULL,
  formaPpago VARCHAR(40) NOT NULL,
...
INSERT INTO pedido VALUES (1,'2019-01-17','2019-01-19','2019-01-19','Entregado','Pagado a plazos',5);
INSERT INTO pedido VALUES (2,'2020-10-23','2020-10-28','2020-10-26','Entregado','La entrega llego antes de lo esperado',5);
INSERT INTO pedido VALUES (3,'2021-06-20','2021-06-25',NULL,'Rechazado','Limite de credito superado',5);
INSERT INTO pedido VALUES (4,'2022-01-20','2022-01-26',NULL,'Pendiente',NULL,5);
INSERT INTO pedido VALUES (8,'2021-11-09','2021-11-14','2021-11-14','Entregado','El cliente paga la mitad con tarjeta y la otra mitad con efectivo, se le realizan dos facturas',1);
INSERT INTO pedido VALUES (9,'2021-12-22','2021-12-27','2021-12-28','Entregado','El cliente comprueba la integridad del paquete, todo correcto',1);
INSERT INTO pedido VALUES (10,'2022-01-15','2022-01-20',NULL,'Pendiente','El cliente llama para confirmar la fecha - Esperando al proveedor',3);
INSERT INTO pedido VALUES (11,'2022-01-20','2022-01-27',NULL,'Pendiente','El cliente requiere que el pedido se le entregue de 16:00h a 22:00h',1);
INSERT INTO pedido VALUES (12,'2022-01-22','2022-01-27',NULL,'Pendiente','El cliente requiere que el pedido se le entregue de 9:00h a 13:00h',1);
INSERT INTO pedido VALUES (13,'2022-01-12','2022-01-14','2022-01-15','Entregado',NULL,7);
INSERT INTO pedido VALUES (14,'2022-01-02','2022-01-02',null,'Rechazado','mal pago',7);
INSERT INTO pedido VALUES (15,'2022-01-09','2022-01-12','2022-01-11','Entregado',NULL,7);
INSERT INTO pedido VALUES (16,'2022-01-06','2022-01-07','2022-01-15','Entregado',NULL,7);
INSERT INTO pedido VALUES (17,'2022-01-08','2022-01-09','2022-01-11','Entregado','mal estado',7);
INSERT INTO pedido VALUES (18,'2022-01-05','2022-01-06','2022-01-07','Entregado',NULL,9);
INSERT INTO pedido VALUES (19,'2022-01-18','2022-02-12',NULL,'Pendiente','entregar en murcia',9);
INSERT INTO pedido VALUES (20,'2022-01-20','2022-02-15',NULL,'Pendiente',NULL,9);
INSERT INTO pedido VALUES (21,'2022-01-09','2022-01-09','2022-01-09','Rechazado','mal pago',9);
INSERT INTO pedido VALUES (22,'2022-01-11','2022-01-11','2022-01-13','Entregado',NULL,9);
INSERT INTO pedido VALUES (23,'2021-12-30','2022-01-10',NULL,'Rechazado','El pedido fue anulado por el cliente',5);
INSERT INTO pedido VALUES (24,'2021-07-14','2021-07-31','2021-07-25','Entregado',NULL,14);
INSERT INTO pedido VALUES (25,'2022-02-02','2022-02-08',NULL,'Rechazado','El cliente carece de saldo en la cuenta asociada',1);
INSERT INTO pedido VALUES (26,'2022-02-06','2022-02-12',NULL,'Rechazado','El cliente anula la operacion para adquirir mas producto',3);
INSERT INTO pedido VALUES (27,'2022-02-07','2022-02-13',NULL,'Entregado','El pedido aparece como entregado pero no sabemos en que fecha',3);
INSERT INTO pedido VALUES (28,'2022-02-10','2022-02-17','2022-02-20','Entregado','El cliente se queja bastante de la espera asociada al producto',3);
INSERT INTO pedido VALUES (29,'2021-08-01','2021-09-01','2021-09-01','Rechazado','El cliente no está conforme con el pedido',14);
INSERT INTO pedido VALUES (30,'2021-08-03','2021-09-03','2021-08-31','Entregado',NULL,13);
INSERT INTO pedido VALUES (31,'2021-09-04','2021-09-30','2021-10-04','Rechazado','El cliente ha rechazado por llegar 5 dias tarde',13);
INSERT INTO pedido VALUES (32,'2020-01-07','2020-01-19','2020-01-27','Entregado','Entrega tardia, el cliente puso reclamacion',4);
INSERT INTO pedido VALUES (33,'2020-05-20','2020-05-28',NULL,'Rechazado','El pedido fue anulado por el cliente',4);
INSERT INTO pedido VALUES (34,'2020-06-20','2021-06-28','2021-06-28','Entregado','Pagado a plazos',4);
INSERT INTO pedido VALUES (35,'2021-03-10','2022-03-20',NULL,'Rechazado','Limite de credito superado',4);
INSERT INTO pedido VALUES (36,'2021-10-15','2021-12-15','2021-12-10','Entregado',NULL,14);
INSERT INTO pedido VALUES (37,'2021-11-03','2022-11-13',NULL,'Pendiente','El pedido nunca llego a su destino',4);
INSERT INTO pedido VALUES (38,'2022-03-05','2022-03-06','2022-03-07','Entregado',NULL,19);
INSERT INTO pedido VALUES (39,'2022-03-06','2022-03-07','2022-03-09','Pendiente',NULL,19);
INSERT INTO pedido VALUES (40,'2022-03-09','2022-03-10','2022-03-13','Rechazado',NULL,19);
INSERT INTO pedido VALUES (41,'2022-03-12','2022-03-13','2022-03-13','Entregado',NULL,19);
INSERT INTO pedido VALUES (42,'2022-03-22','2022-03-23','2022-03-27','Entregado',NULL,19);
INSERT INTO pedido VALUES (43,'2022-03-25','2022-03-26','2022-03-28','Pendiente',NULL,23);
INSERT INTO pedido VALUES (44,'2022-03-26','2022-03-27','2022-03-30','Pendiente',NULL,23);
INSERT INTO pedido VALUES (45,'2022-04-01','2022-03-04','2022-03-07','Entregado',NULL,23);
INSERT INTO pedido VALUES (46,'2022-04-03','2022-03-04','2022-03-05','Rechazado',NULL,23);
INSERT INTO pedido VALUES (47,'2022-04-15','2022-03-17','2022-03-17','Entregado',NULL,23);
INSERT INTO pedido VALUES (48,'2021-03-17','2021-03-30','2021-03-29','Entregado','Según el Cliente, el pedido llegó defectuoso',26);
INSERT INTO pedido VALUES (49,'2021-07-12','2021-07-22','2021-07-30','Entregado','El pedido llegó 1 día tarde, pero no hubo queja por parte de la empresa compradora',26);
INSERT INTO pedido VALUES (50,'2021-03-17','2021-08-09',NULL,'Pendiente','Al parecer, el pedido se ha extraviado a la altura de Sotalbo (Ávila)',26);
INSERT INTO pedido VALUES (51,'2021-10-01','2021-10-14','2021-10-14','Entregado','Todo se entregó a tiempo y en perfecto estado, a pesar del pésimo estado de las carreteras.',26);
INSERT INTO pedido VALUES (52,'2021-12-07','2021-12-21',NULL,'Pendiente','El transportista ha llamado a Eva María para indicarle que el pedido llegará más tarde de lo esperado.',26);
INSERT INTO pedido VALUES (53,'2021-10-15','2021-11-15','2021-11-09','Entregado','El pedido llega 6 dias antes',13);
INSERT INTO pedido VALUES (54,'2022-01-11','2022-02-11',NULL,'Pendiente',NULL,14);
INSERT INTO pedido VALUES (55,'2021-12-10','2022-01-10','2022-01-11','Entregado','Retrasado 1 dia por problemas de transporte',14);
INSERT INTO pedido VALUES (56,'2021-12-19','2022-01-20',NULL,'Rechazado','El cliente a anulado el pedido el dia 2022-01-10',13);
INSERT INTO pedido VALUES (57,'2022-01-05','2022-02-05',NULL,'Pendiente',NULL,13);
INSERT INTO pedido VALUES (58,'2022-01-24','2022-01-31','2022-01-30','Entregado','Todo correcto',3);
INSERT INTO pedido VALUES (59,'2021-11-09','2021-11-14','2021-11-14','Entregado','El cliente paga la mitad con tarjeta y la otra mitad con efectivo, se le realizan dos facturas',1);
INSERT INTO pedido VALUES (60,'2021-12-22','2021-12-27','2021-12-28','Entregado','El cliente comprueba la integridad del paquete, todo correcto',1);
INSERT INTO pedido VALUES (61,'2022-01-15','2022-01-20',NULL,'Pendiente','El cliente llama para confirmar la fecha - Esperando al proveedor',3);
INSERT INTO pedido VALUES (62,'2022-01-20','2022-01-27',NULL,'Pendiente','El cliente requiere que el pedido se le entregue de 16:00h a 22:00h',1);
INSERT INTO pedido VALUES (63,'2022-01-22','2022-01-27',NULL,'Pendiente','El cliente requiere que el pedido se le entregue de 9:00h a 13:00h',1);
INSERT INTO pedido VALUES (64,'2022-01-24','2022-01-31','2022-01-30','Entregado','Todo correcto',1);
INSERT INTO pedido VALUES (65,'2022-02-02','2022-02-08',NULL,'Rechazado','El cliente carece de saldo en la cuenta asociada',1);
INSERT INTO pedido VALUES (66,'2022-02-06','2022-02-12',NULL,'Rechazado','El cliente anula la operacion para adquirir mas producto',3);
INSERT INTO pedido VALUES (67,'2022-02-07','2022-02-13',NULL,'Entregado','El pedido aparece como entregado pero no sabemos en que fecha',3);
INSERT INTO pedido VALUES (68,'2022-02-10','2022-02-17','2022-02-20','Entregado','El cliente se queja bastante de la espera asociada al producto',3);
INSERT INTO pedido VALUES (74,'2022-01-14','2022-01-22',NULL,'Rechazado','El pedido no llego el dia que queria el cliente por fallo del transporte',15);
INSERT INTO pedido VALUES (75,'2022-01-11','2022-01-13','2022-01-13','Entregado','El pedido llego perfectamente',15);
INSERT INTO pedido VALUES (76,'2021-11-15','2021-11-23','2021-11-23','Entregado',NULL,15);
INSERT INTO pedido VALUES (77,'2022-01-03','2022-01-08',NULL,'Pendiente','El pedido no pudo ser entregado por problemas meteorologicos',15);
INSERT INTO pedido VALUES (78,'2021-12-15','2021-12-17','2021-12-17','Entregado','Fue entregado, pero faltaba mercancia que sera entregada otro dia',15);
INSERT INTO pedido VALUES (79,'2022-01-12','2022-01-13','2022-01-13','Entregado',NULL,28);
INSERT INTO pedido VALUES (80,'2022-01-25','2022-01-26',NULL,'Pendiente','No terminó el pago',28);
INSERT INTO pedido VALUES (81,'2022-01-18','2022-01-24',NULL,'Rechazado','Los producto estaban en mal estado',28);
INSERT INTO pedido VALUES (82,'2022-01-20','2022-01-29','2022-01-29','Entregado','El pedido llego un poco mas tarde de la hora fijada',28);
INSERT INTO pedido VALUES (83,'2022-01-24','2022-01-28',NULL,'Entregado',NULL,28);
INSERT INTO pedido VALUES (89,'2020-10-05','2020-12-13','2020-12-10','Entregado','La entrega se realizo dias antes de la fecha esperada por lo que el cliente quedo satisfecho',35);
INSERT INTO pedido VALUES (90,'2022-02-07','2021-02-17',NULL,'Pendiente','Debido a la nevada caída en la sierra, el pedido no podrá llegar hasta el día ',27);
INSERT INTO pedido VALUES (91,'2022-03-18','2022-03-29','2022-03-27','Entregado','Todo se entregó a su debido tiempo, incluso con un día de antelación',27);
INSERT INTO pedido VALUES (92,'2022-04-19','2022-04-30','2022-05-03','Entregado','El pedido se entregó tarde debido a la festividad celebrada en España durante esas fechas',27);
INSERT INTO pedido VALUES (93,'2022-05-03','2022-05-30','2022-05-17','Entregado','El pedido se entregó antes de lo esperado.',27);
INSERT INTO pedido VALUES (94,'2022-10-18','2022-11-01',NULL,'Pendiente','El pedido está en camino.',27);
INSERT INTO pedido VALUES (95,'2021-01-04','2021-01-19','2021-01-19','Entregado',NULL,35);
INSERT INTO pedido VALUES (96,'2021-03-20','2021-04-12','2021-04-13','Entregado','La entrega se retraso un dia',35);
INSERT INTO pedido VALUES (97,'2021-10-08','2021-11-25','2021-11-25','Entregado',NULL,35);
INSERT INTO pedido VALUES (98,'2022-01-08','2022-02-13',NULL,'Pendiente',NULL,35);
INSERT INTO pedido VALUES (99,'2022-02-15','2022-02-27',NULL,'Pendiente',NULL,16);
INSERT INTO pedido VALUES (100,'2022-01-10','2022-01-15','2022-01-15','Entregado','El pedido llego perfectamente',16);
INSERT INTO pedido VALUES (101,'2022-03-07','2022-03-27',NULL,'Rechazado','El pedido fue rechazado por el cliente',16);
INSERT INTO pedido VALUES (102,'2021-12-28','2022-01-08','2022-01-08','Entregado','Pago pendiente',16);
INSERT INTO pedido VALUES (103,'2022-01-15','2022-01-20','2022-01-24','Pendiente',NULL,30);
INSERT INTO pedido VALUES (104,'2022-03-02','2022-03-06','2022-03-06','Entregado',NULL,30);
INSERT INTO pedido VALUES (105,'2022-02-14','2022-02-20',NULL,'Rechazado','el producto ha sido rechazado por la pesima calidad',30);
INSERT INTO pedido VALUES (106,'2022-05-13','2022-05-15','2022-05-20','Pendiente',NULL,30);
INSERT INTO pedido VALUES (107,'2022-04-06','2022-04-10','2022-04-10','Entregado',NULL,30);
INSERT INTO pedido VALUES (108,'2022-04-09','2022-04-15','2022-04-15','Entregado',NULL,16);
INSERT INTO pedido VALUES (109,'2019-05-25','2019-07-28','2019-07-28','Entregado',NULL,38);
INSERT INTO pedido VALUES (110,'2020-03-19','2020-04-24','2020-04-24','Entregado',NULL,38);
INSERT INTO pedido VALUES (111,'2021-03-05','2021-03-30','2021-03-30','Entregado',NULL,36);
INSERT INTO pedido VALUES (112,'2022-03-05','2022-04-06','2022-05-07','Pendiente',NULL,36);
INSERT INTO pedido VALUES (113,'2021-10-28','2021-11-09','2022-01-09','Rechazado','El producto ha sido rechazado por la tardanza de el envio',36);
INSERT INTO pedido VALUES (114,'2022-01-15','2022-01-29','2022-01-31','Entregado','El envio llego dos dias más tarde debido al mal tiempo',36);
INSERT INTO pedido VALUES (115,'2021-11-29','2022-01-26','2022-02-27','Pendiente',NULL,36);
INSERT INTO pedido VALUES (116,'2021-06-28','2021-08-01','2021-08-01','Entregado',NULL,38);
INSERT INTO pedido VALUES (117,'2021-08-25','2021-10-01',NULL,'Rechazado','El pedido ha sido rechazado por la acumulacion de pago pendientes del cliente',38);
INSERT INTO pedido VALUES (118,'2022-02-15','2022-02-27',NULL,'Pendiente',NULL,16);
INSERT INTO pedido VALUES (119,'2022-01-10','2022-01-15','2022-01-15','Entregado','El pedido llego perfectamente',16);
INSERT INTO pedido VALUES (120,'2022-03-07','2022-03-27',NULL,'Rechazado','El pedido fue rechazado por el cliente',16);
INSERT INTO pedido VALUES (121,'2021-12-28','2022-01-08','2022-01-08','Entregado','Pago pendiente',16);
INSERT INTO pedido VALUES (122,'2022-04-09','2022-04-15','2022-04-15','Entregado',NULL,16);
INSERT INTO pedido VALUES (123,'2022-01-15','2022-01-20','2022-01-24','Pendiente',NULL,30);
INSERT INTO pedido VALUES (124,'2022-03-02','2022-03-06','2022-03-06','Entregado',NULL,30);
INSERT INTO pedido VALUES (125,'2022-02-14','2022-02-20',NULL,'Rechazado','el producto ha sido rechazado por la pesima calidad',30);
INSERT INTO pedido VALUES (126,'2022-05-13','2022-05-15','2022-05-20','Pendiente',NULL,30);
INSERT INTO pedido VALUES (127,'2022-04-06','2022-04-10','2022-04-10','Entregado',NULL,30);
INSERT INTO pedido VALUES (128,'2021-11-10','2021-12-10','2021-12-29','Rechazado','El pedido ha sido rechazado por el cliente por el retraso en la entrega',38);
...
INSERT INTO pago VALUES (3,'PayPal','ak-std-000003','2022-01-16',5000);
INSERT INTO pago VALUES (3,'PayPal','ak-std-000004','2022-02-16',5000);
INSERT INTO pago VALUES (3,'PayPal','ak-std-000005','2022-02-19',926);
INSERT INTO pago VALUES (4,'PayPal','ak-std-000006','2020-01-08',20000);
INSERT INTO pago VALUES (4,'PayPal','ak-std-000007','2020-01-08',20000);
INSERT INTO pago VALUES (4,'PayPal','ak-std-000008','2020-01-08',20000);
INSERT INTO pago VALUES (4,'PayPal','ak-std-000009','2020-01-08',20000);
INSERT INTO pago VALUES (4,'PayPal','ak-std-000010','2020-01-08',1849);
INSERT INTO pago VALUES (5,'Transferencia','ak-std-000011','2019-01-18',23794);
INSERT INTO pago VALUES (7,'Cheque','ak-std-000012','2022-01-13',2390);
INSERT INTO pago VALUES (9,'PayPal','ak-std-000013','2022-01-06',929);
...
INSERT INTO pago VALUES (15,'PayPal','ak-std-000016','2022-01-15',2081);
INSERT INTO pago VALUES (15,'PayPal','ak-std-000035','2022-02-15',10000);
INSERT INTO pago VALUES (16,'PayPal','ak-std-000017','2022-02-16',4399);
INSERT INTO pago VALUES (19,'PayPal','ak-std-000018','2022-03-06',232);
INSERT INTO pago VALUES (23,'PayPal','ak-std-000019','2022-03-26',272);
INSERT INTO pago VALUES (26,'PayPal','ak-std-000020','2021-03-18',18846);
INSERT INTO pago VALUES (27,'PayPal','ak-std-000021','2022-02-08',10972);
INSERT INTO pago VALUES (28,'PayPal','ak-std-000022','2022-01-13',8489);
INSERT INTO pago VALUES (30,'PayPal','ak-std-000024','2022-01-16',7863);
INSERT INTO pago VALUES (35,'PayPal','ak-std-000025','2020-10-06',3321);
INSERT INTO pago VALUES (38,'PayPal','ak-std-000026','2019-05-26',1171);
